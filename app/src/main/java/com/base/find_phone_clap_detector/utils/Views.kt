package com.horse.identification.extensions
...
import com.base.find_phone_clap_detector.databinding.DialoguePasscodeOptionsBinding
import com.base.find_phone_clap_detector.databinding.DialoguePasscordSavedBinding
import com.base.find_phone_clap_detector.databinding.DialogueRecordYourVoicePasscodeBinding
...
fun BottomSheetDialogFragment.openBottomSheet(activity: FragmentActivity?) {
    Log.d("SCANNING_ACTIVITY", "openBottomSheet: $isAdded")
...
fun Context.showPasscodeDialog(
    onRecordVoiceClick: () -> Unit,
    onTextToVoiceClick: () -> Unit
) {
    val dialog = Dialog(this, R.style.CustomDialog)
    val binding = DialoguePasscodeOptionsBinding.inflate(LayoutInflater.from(this))
    ...
    // Set dialog full width with 7dp margin
    dialog.window?.setLayout(
        (resources.displayMetrics.widthPixels * 0.95).toInt(), // Almost match_parent
...
fun Context.showPasscodeSavedDialog(
    onOkayClick: () -> Unit,
) {
    val dialog = Dialog(this, R.style.CustomDialog)
    val binding = DialoguePasscordSavedBinding.inflate(LayoutInflater.from(this))
    dialog.setContentView(binding.root)
    dialog.setCancelable(true)
